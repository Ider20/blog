...
export const Header = () => {
  ...
  return (
    <div className="fixed z-10 bg-white  flex justify-between   lg:w-full  lg:flex lg:m-auto lg:justify-between lg:py-8 lg:items-center lg:mb-10">
      <div className="flex justify-between w-[375px] p-5  lg:w-[1216px] lg:flex lg:m-auto lg:justify-between">
        <div>
